...
async function generateAtlases() {
    ...
    try {
        ...
        const data = `export const atlases = ${JSON.stringify(atlases)}`;
        const file = join(assetsPath, "assetsNames/atlas.js");
...
async function generateUncompressedSprites() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetsNames/assets.js");
...
async function generateAudioAssets() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetsNames/audio.js");
...
async function generateFonts() {
    ...
    try {
        ...
        const file = join(assetsPath, "assetsNames/fonts.js");
        const data = `export const fonts = ${JSON.stringify(filesNamesAndPath)}`;
        await fs.writeFile(file, data);
        await runPrettierOn(file);
    } catch (e) {
        console.log(e.message);
